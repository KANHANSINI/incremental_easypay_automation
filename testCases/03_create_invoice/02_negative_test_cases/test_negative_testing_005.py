...
class TestCreateInvoice:
    ...
    # Copy item in Discount, without selecting a discount before
    def test_negative_testing_005(self, setup):
        self.driver = setup
        ...
        sleep(MEDIUM_WAIT)
        self.create_guest_page.click_copy_discount()
        sleep(SHORT_WAIT)

        try:
            success_message = 'Please select a discount.'
