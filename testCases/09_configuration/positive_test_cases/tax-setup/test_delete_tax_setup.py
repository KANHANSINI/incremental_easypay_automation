...
#
#     def test_edit_payment_settings(self, setup):
#         self.driver = setup
...
#         sleep(SHORT_WAIT)
#         self.configuration.click_delete_payment_settings()
#         sleep(SHORT_WAIT)
#         try:
...
#             allure.attach(self.driver.get_screenshot_as_png(), name="delete_payment_settings_failed_scr",
