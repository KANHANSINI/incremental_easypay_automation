...
class TestConfigurations:
    ...
    def test_edit_email_configurations(self, setup):
        self.driver = setup
        ...
        sleep(SHORT_WAIT)
        self.configuration.click_edit_email_configurations()
        sleep(SHORT_WAIT)
        try:
            ...
            allure.attach(self.driver.get_screenshot_as_png(), name="edit_email_configurations_failed_scr",
