...
class TestConfigurations:
    ...
    def test_edit_organizational_details(self, setup):
        self.driver = setup
        ...
        sleep(SHORT_WAIT)
        self.configuration.click_delete_organizational_details()
        sleep(SHORT_WAIT)
        try:
            ...
            allure.attach(self.driver.get_screenshot_as_png(), name="delete_organizational_details_failed_scr",
