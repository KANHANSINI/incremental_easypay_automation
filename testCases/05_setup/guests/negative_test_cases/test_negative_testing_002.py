...
class TestSetUp:
    ...
    def test_add_invalid_address(self, setup):
        self.driver = setup
        ...
        self.create_guest_page.add_new_guest(CreateNewGuestTestData.first_name,
                                             ...
                                             CreateNewGuestTestData_NegativeTesting.address_line_1,
                                             CreateNewGuestTestData_NegativeTesting.address_line_2,
                                             CreateNewGuestTestData.zip_code)
        sleep(SHORT_WAIT)
        try:
            success_message = 'Add new guest record failed, Please try again'
            x = perform_create_new_guest_negative_testing_assertion(self.driver, self.create_guest_page,
