...
from utilities.test_utils import (sleep, SHORT_WAIT, perform_duplicate_records_discount_assertion)
...
class TestSetUp:
    ...
    def test_duplicate_discounts(self, setup):
        self.driver = setup
        ...
        try:
            ...
            perform_duplicate_records_discount_assertion(self.driver, self.discount, self.logger, success_message)

        except Exception as e:
            allure.attach(self.driver.get_screenshot_as_png(), name="duplicate_discounts_failed_scr",
