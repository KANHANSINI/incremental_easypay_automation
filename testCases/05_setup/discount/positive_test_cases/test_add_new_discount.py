...
from utilities.test_utils import sleep, SHORT_WAIT, MEDIUM_WAIT, perform_create_new_item_assertion, \
    perform_create_new_discount_assertion
...
class TestSetUp:
    ...
    def test_add_new_discount(self, setup):
        self.driver = setup
        ...
        try:
            ...
            perform_create_new_discount_assertion(self.driver, self.discount, self.logger, success_message)
