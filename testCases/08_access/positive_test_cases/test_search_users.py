...
class TestAccess:
    ...
    def test_search_users(self, setup):
        self.driver = setup
        ...
        sleep(SHORT_WAIT)
        self.access.search_user_by_name("Ishadi")
        sleep(SHORT_WAIT)
        self.access.search_user_by_email("ishadi@ceydigital.com")
        sleep(SHORT_WAIT)
        self.access.search_user_by_role("Front Office")
        sleep(SHORT_WAIT)
        self.driver.close()
