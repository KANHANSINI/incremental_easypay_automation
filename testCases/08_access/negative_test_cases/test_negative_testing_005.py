...
class TestAccess:
    ...
    def test_create_user_without_enter_password(self, setup):
        self.driver = setup
        ...
        sleep(SHORT_WAIT)
        self.access.create_new_user_without_enter_password()
        sleep(SHORT_WAIT)
        self.driver.close()

    def test_create_user_enter_invalid_password(self, setup):
        self.driver = setup
        self.driver.get(self.base_url)
        self.login = LoginPage(self.driver)
        self.login.login_to_application(self.username, self.password)
        ...
        self.access.click_users()
        sleep(SHORT_WAIT)
        self.access.create_new_user_with_enter_invalid_password("abcd1234")
        sleep(SHORT_WAIT)
        self.driver.close()
